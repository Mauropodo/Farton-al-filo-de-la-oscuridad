...
| **Historia** (INT) | +2 | ✓ |
| **Investigación** (INT) | +2 | ✓ |
| **Juego de manos** (DES) | +7 | ★ Pericia |
| **Percepción** (SAB) | +3 | ✓ |
| **Perspicacia** (SAB) | +3 | ✓ |
| **Persuasión** (CAR) | +2 | |
| **Sigilo** (DES) | +7 | ★ Pericia |
| **Supervivencia** (SAB) | +3 | ✓ |
...
| Diario de tapas gastadas (regalo de Rupert) | 1        |
| Mochila                                     | 1        |
| Cuerda de cáñamo (15 m)                     | 1        |
...
### Raciales (Mediano Piesligeros)

**Valiente.** Ventaja en tiradas de salvación contra asustado.
**Sigilo natural.** Puede intentar esconderse detrás de criaturas de al menos un tamaño mayor que él.
**Suerte mediana.** Cuando saca un 1 natural en una tirada de ataque, habilidad o salvación, puede repetirla y quedarse con el nuevo resultado.
...
| 5 | **Temblor** | Desventaja en Juego de manos y Destreza (sigilo). |
| 6 | **Insomnio** | No puede hacer descansos largos. Necesita un día completo de inactividad para recuperarse. |

**Situaciones que gatillan un trauma:**
- Pierde 5+ puntos de cordura de un solo golpe
- La cordura baja por primera vez del 50% (32 o menos)
- La cordura baja por primera vez del 25% (16 o menos)
- Se enfrenta al mismo horror que ya le provocó una pérdida de cordura
- Fracasa una tirada de salvación relacionada con la entidad

**Curar traumas:** Un descanso largo en un lugar seguro permite repetir la Salvación de Sabiduría CD 13. Si tiene éxito, el trauma desaparece.

**Cordura 0:** El personaje cae en locura permanente. Queda fuera de juego.

**Recuperación de cordura:** Completar el ritual de destierro restaura 2d10 + nivel de Cordura. Descansar en un lugar seguro sin incidentes recupera 1d4 por día.
